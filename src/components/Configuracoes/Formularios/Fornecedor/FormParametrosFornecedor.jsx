                                ...
                                {departamentos && (
                                    <>
                                        <Select
                                            ...
                                            form={form}
                                            helpText='Profissionais deste departamento terão permissão para preencher o formulário. Se nenhum profissional for selecionado, o sistema não fará o controle de permissão para este formulário (válido apenas para preenchimento da fábrica)'
                                        />
                                        <Select
                                            xs={12}
                                            md={6}
                                            ...
                                            form={form}
                                            helpText='Profissionais deste departamento terão permissão para concluir/aprovar o formulário. Se nenhum profissional for selecionado, o sistema não fará o controle de permissão para este formulário (válido apenas para preenchimento da fábrica)'
                                        />
                                    </>
                                )}
