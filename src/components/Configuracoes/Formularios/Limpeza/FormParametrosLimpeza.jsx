...
const FormParametrosLimpeza = ({ id }) => {
    ...
    const onSubmit = async values => {
        ...
        try {
            if (type === 'new') {
                //? New
                await api.put(`/configuracoes/formularios/limpeza/insertData`, data).then(response => {
                ...
                //? Edit
                await api.put(`/configuracoes/formularios/limpeza/updateData`, data).then(response => {
                    toast.success(toastMessage.successUpdate)
    ...
    const getData = () => {
        try {
            if (type === 'new') {
                ...
                api.post(`/configuracoes/formularios/limpeza/getData/${id}`, {
                    unidadeID: loggedUnity.unidadeID
                }).then(response => {
